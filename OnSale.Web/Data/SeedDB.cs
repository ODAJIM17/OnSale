...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Jimmy", "Davila", "davila56jd@gmail.com", "786 367 0678", "Calle Luna Calle Sol", UserType.Admin);
        ...
        private async Task CheckProductsAsync()
        {
            ...
            {
                User user = await _userHelper.GetUserAsync("davila56jd@gmail.com");
